...
export async function listCanvases(): Promise<ListCanvasesResponse[]> {
  const response = await apiFetch('/api/canvas/list')
...
export async function createCanvas(data: {
  ...
  const response = await apiFetch('/api/canvas/create', {
    method: 'POST',
...
export async function saveCanvas(
  ...
  const response = await apiFetch(`/api/canvas/${id}/save`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
export async function renameCanvas(id: string, name: string): Promise<void> {
  const response = await apiFetch(`/api/canvas/${id}/rename`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
export async function deleteCanvas(id: string): Promise<void> {
  const response = await apiFetch(`/api/canvas/${id}/delete`, {
    method: 'DELETE',
  })
  return await response.json()
}
